...
<div class="row heading-bg">
	<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
	  <h5 class="txt-dark">Inward Report</h5>
	</div>
	<!-- Breadcrumb -->
	<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
	  <ol class="breadcrumb">
		...
		<li class="active"><span>Inward Report</span></li>
	  </ol>
	</div>
	<!-- /Breadcrumb -->
</div>
				...
				<div class="panel-body">
					...
					<div class="tab-struct vertical-tab custom-tab-1 mt-40">
						<ul role="tablist" class="nav nav-tabs ver-nav-tab" id="myTabs_8" style="min-height: 170px;">
							<li class="active" role="presentation"><a aria-expanded="true" data-toggle="tab" role="tab" id="home_tab_8" href="#home_8"><h6 class="txt-dark capitalize-font"><i class="icon-calender mr-10"></i>Inward Cheque by Date</h6></a></li>
							<li role="presentation" class=""><a data-toggle="tab" id="profile_tab_8" role="tab" href="#profile_8" aria-expanded="false"><h6 class="txt-dark capitalize-font"><i class="ti-credit-card mr-10"></i>Inward Cheque by Account No</h6></a></li>
							<li role="presentation" class=""><a data-toggle="tab" id="rofile_tab_8" role="tab" href="#rofile_8" aria-expanded="false"><h6 class="txt-dark capitalize-font"><i class="icon-home mr-10"></i>Inward Cheque by Company</h6></a></li>
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control select2" name="account" id="account" required oninvalid="this.setCustomValidity('Please Select Account')" onchange="setCustomValidity('')">
													<option value="">--Select--</option>
													<?php $cus = $this->Crud->read('account'); foreach ($cus as $key) {?>
													<option value="<?php echo $key->id; ?>"><?php echo strtoupper($key->account_num.' - '.$key->account_name); ?></option>
													<?php }?>
												</select>
											</div>
										</div> 
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control select2" name="company" id="company" required oninvalid="this.setCustomValidity('Choose Company')" onchange="setCustomValidity('')">
										...
										<div class="col-md-6">
											<label class="control-label mb-10">.</label><br>
											<button class="btn btn-success btn-rounded btn-block btn-anim" id="btn-comp"><i class="icon-magnifier"></i><span class="btn-text">GENERATE BY COMPANY</span></button>
										</div>
										<div class="col-md-6">
											<label class="control-label mb-10">.</label><br>
											<button class="btn btn-info btn-rounded btn-block btn-anim" id="btn-date-comp"><i class="icon-magnifier"></i><span class="btn-text">GENERATE BY COMPANY AND DATE</span></button>
										</div>
										<!--/span--><div class="col-md-8">.</div>
									</div><div id="company_response" align="center"></div>
	...
	<script type="text/javascript">
	    $(document).ready(function(){
	        ...
	        $('#btn-date').on('click', function(){
	        	...
	        	$.ajax({
		            url: '<?php echo base_url('cheque/date/'); ?>'+ date_to +'/' + date_from,
	        ...
	        $('#btn-account').on('click', function(){
	        	...
	        	$.ajax({
		            url: '<?php echo base_url('cheque/account/'); ?>'+ account +'/' + date_from1 +'/' + date_to1,
		            success: function(data) {
	        ...
	        $('#btn-comp').on('click', function(){
	        	...
	        	$.ajax({
		            url: '<?php echo base_url('cheque/company/'); ?>'+ company,
		            success: function(data) {
	        ...
	        $('#btn-date-comp').on('click', function(){
				...
				$('#company_response').html('<div class="text-center col-lg-12"><i class="fa fa-spinner fa-pulse fa-2x fa-fw"></i> please wait...</div>');
	        	$.ajax({
		            url: '<?php echo base_url('cheque/date_comp/'); ?>'+ company +'/' + date_from2 +'/' + date_to2,
		            success: function(data) {
		                $('#company_response').html(data);
		            }
		        });
