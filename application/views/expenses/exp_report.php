				...
				<div class="panel-body">
					...
					<div class="tab-struct vertical-tab custom-tab-1 mt-40">
						<ul role="tablist" class="nav nav-tabs ver-nav-tab" id="myTabs_8" style="min-height: 170px;">
							<li class="active" role="presentation"><a aria-expanded="true" data-toggle="tab" role="tab" id="home_tab_8" href="#home_8"><h6 class="txt-dark capitalize-font"><i class="icon-calender mr-10"></i>Expenses Report by Date</h6></a></li>
							<li role="presentation" class=""><a data-toggle="tab" id="profile_tab_8" role="tab" href="#profile_8" aria-expanded="false"><h6 class="txt-dark capitalize-font"><i class="ti-credit-card mr-10"></i>Expenses Report by Cost Center</h6></a></li>
							...
							<div id="profile_8" class="tab-pane fade" role="tabpanel">
								<div class="form-body">
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label mb-10">Cost Center</label>
												<select class="form-control select2" name="cost" id="cost" required oninvalid="this.setCustomValidity('Please Select Cost Center')" onchange="setCustomValidity('')">
													<option value="">--Select--</option>
													<?php $cus = $this->Crud->read('cost'); foreach ($cus as $key) {?>
										...
										<div class="col-md-6">
											<label class="control-label mb-10">.</label><br>
											<button class="btn btn-success btn-rounded btn-block btn-anim" id="btn-cost"><i class="icon-magnifier"></i><span class="btn-text">GENERATE</span></button>
										</div>
										<div class="col-md-6">
											.
										</div>
										<!--/span-->
									</div><div id="cost_response" align="center"></div>
	...
	<script type="text/javascript">
	    $(document).ready(function(){
	        ...
	        $('#btn-date').on('click', function(){
	        	...
	        	$.ajax({
		            url: '<?php echo base_url('expenses/date/'); ?>'+ date_to +'/' + date_from,
	        ...
	        $('#btn-cost').on('click', function(){
	        	...
	        	// show prograss loading
				$('#cost_response').html('<div class="text-center col-lg-12"><i class="fa fa-spinner fa-pulse fa-2x fa-fw"></i> please wait...</div>');
	        	$.ajax({
		            url: '<?php echo base_url('expenses/cos/'); ?>'+ cost +'/' + date_from1 +'/' + date_to1,
		            success: function(data) {
		                $('#cost_response').html(data);
		            }
		        });
	        	return false;
	        });
