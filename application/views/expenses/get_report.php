										...
										<div class="table-responsive">
											...
											<?php if ($report_type == 'date_report') {?>
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<?php $ser = $this->Crud->date_range($param2, 'date', $param3, 'date', 'expenses');
														if (empty($ser)) { ?>
																							...
																							<tbody style="font-size: 12px; text-align: center;">
																								<?php $f= 0; 
																									...
																									<tr>
																										...
																										<td><?php echo strtoupper($key->details); ?></td>
											...
											<?php } elseif ($report_type == 'cost_report') { ?>
												<h5 class="txt-dark capitalize-font" align="center"><?php echo $title; ?></h5>
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<?php $ser = $this->Crud->date_range1($param3, 'date', $param2, 'date', 'cost_center', str_replace('_', ' ', $param4), 'expenses');//echo $param3.' '.$param2.' '.$param4;
														if (empty($ser)) { ?>
															<div align="right">0 Record</div>
															<div class="panel panel-default cardview">
																<div class="pane-wrapper collapse in">
